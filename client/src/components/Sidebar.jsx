...
import { Calendar, CalendarIcon, ChevronRightCircleIcon, DollarSignIcon, FileTextIcon, LayoutGridIcon, LineChart, Loader2Icon, LogOutIcon, MenuIcon, SettingsIcon, User, UserIcon, XIcon } from 'lucide-react'
  ...
  const handleLogout = () => {
    ...
    const sidebarContent = (
      <>
        ...
        {userName && (
          <div
            className="mx-3 mt-4 mb-1 p-3 rounded-lg bg-white/3
          ...
          {loading ? (
            ...
            return (
              ...
              >
                {isActive && (
                  <div
                    className="absolute left-0 top-1/2 -translate-y-1/2 
                            w-[3px] h-5 rounded-r-full bg-indigo-500"
                  />
                )}
                <item.icon
                ...
                {isActive && (
                  <ChevronRightCircleIcon className="w-3.5 h-3.5 text-indigo-500/50" />
                )}
              </Link>
            );
          })
        ...
        <div className="p-3 border-t border-white/6">
          ...
          gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium
