...
import { Shield, User, ArrowRightIcon } from "lucide-react";
    ...
    const portalOptions = [
      {
        ...
        title: "Admin Portal",
        description:
          "Manage employees, department, payroll, and system configurations.",
        icon: Shield,
      },
      {
        to: "/login/employee",
              ...
              {portalOptions.map((portal) => (
                <Link
                  ...
                  className="group block bg-slate-50 border border-slate-200 
                            rounded-lg p-5 sm:p-6 transition-all duration-300 
